                ...
                <div className="flex justify-center mb-8 gap-4 flex-wrap" data-aos-delay="600" data-aos="fade-down">
                    {experienceData.tabs.map((tab) => (
                        <button
                            ...
                            className={`flex items-center gap-2 px-5 py-3 rounded-lg shadow-lg text-sm font-medium transition-all ${activeTab === tab
                                ...
                                {experience.details && (
                                    <Tippy content="View Details" placement="top">
                                        <button
                                            ...
                                            className={`px-4 py-2 bg-gray-800 text-white dark:bg-white dark:text-gray-800 rounded-lg font-medium flex items-center justify-center gap-2 transition-all transform hover:-translate-y-1 ${experience.details && experience.companyUrl ? 'w-[70%]' : 'w-full'
                                                }`}
                                        >
                                            Details
                                ...
                                {experience.companyUrl && (
                                    <Tippy content="Visit Company" placement="top">
                                        <button
                                            ...
                                            className={`px-4 py-2 bg-white text-gray-800 dark:bg-gray-800 dark:text-white border border-gray-300 dark:border-gray-700 rounded-lg font-medium flex items-center justify-center gap-2 transition-all transform hover:-translate-y-1 ${experience.details && experience.companyUrl ? 'w-[30%]' : 'w-full'
                                                }`}
                                        >
                                            Company

                                ...
                                {project.demo && (
                                    <Tippy content="View Demo" placement="top">
                                        <button
                                            ...
                                            className={`px-4 py-2 bg-gray-800 text-white dark:bg-white dark:text-gray-800 rounded-lg font-medium flex items-center justify-center gap-2 transition-all transform hover:-translate-y-1 ${project.demo && project.github ? 'w-[70%]' : 'w-full'
                                                }`}
                                        >
                                            Demo
                                ...
                                {project.github && (
                                    <Tippy content="View Code" placement="top">
                                        <button
                                            ...
                                            className={`px-4 py-2 bg-white text-gray-800 dark:bg-gray-800 dark:text-white border border-gray-300 dark:border-gray-700 rounded-lg font-medium flex items-center justify-center gap-2 transition-all transform hover:-translate-y-1 ${project.demo && project.github ? 'w-[30%]' : 'w-full'
                                                }`}
                                        >
                                            Code
